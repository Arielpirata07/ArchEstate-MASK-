window.I18N = {
    es: {
        ...
        'phone.incomplete_autocomplete': 'El número está incompleto o es inválido. Revisá que incluya el código de ciudad y el número completo.',
        ...
        'admin.save': 'Guardar',
        'admin.send_notification_to': 'Notificar a',
        'admin.notification_title_required': 'El título es obligatorio.',
        ...
        'pac.codes': 'códigos',
        'pac.no_results': 'Sin resultados',
        'pac.new_area_code': 'Nuevo Código de Área',
        'pac.edit_area_code': 'Editar Código de Área',
        'pac.missing_fields': 'Código y ciudad son requeridos',
        'pac.saved': 'Código de área guardado',
        'pac.save_error': 'Error al guardar',
    ...
    en: {
        ...
        'phone.incomplete_autocomplete': 'The number is incomplete or invalid. Make sure it includes the city code and the full number.',
        ...
        'admin.save': 'Save',
        'admin.send_notification_to': 'Notify',
        'admin.notification_title_required': 'Title is required.',
        'dashboard.leads': 'Leads',
        ...
        'pac.codes': 'codes',
        'pac.no_results': 'No results',
        'pac.new_area_code': 'New Area Code',
        'pac.edit_area_code': 'Edit Area Code',
        'pac.missing_fields': 'Code and city are required',
        'pac.saved': 'Area code saved',
        'pac.save_error': 'Error saving',
